# VERSION: 4.0 — Two-column layout, no sidebar dependency
...
with left_col:
    ...
    if logo_src:
        ...
        <div class='panel-logo-text'>
            <img src='{logo_src}' style='max-width:130px; border-radius:8px;'/>
    ...
    <div class='panel-section'>
        <div class='panel-title'>📍 Find Us</div>
        MIG, Lane-3, Kalinga Vihar (K9A)<br>
        Bhubaneswar – 751019, Odisha<br>
        <span style='opacity:0.7; font-size:0.73rem;'>Near Vivanta Hotel & D N Regalia Mall</span><br>
        <a href='https://maps.app.goo.gl/B7oszYnEmBxMxLVe8' target='_blank' class='panel-link'>
            🗺️ Open in Maps
        </a>
    </div>""", unsafe_allow_html=True)
    ...
    <div class='panel-section'>
        ...
        <a href='tel:+919853115511' class='panel-link'>📱 +91 98531 15511</a>
        <a href='https://wa.me/919853115511?text=Namaskar%20Bini%20Didi!%20I%20would%20like%20to%20know%20more%20about%20your%20services.'
           target='_blank' class='wa-btn'>💬 Chat on WhatsApp</a>
    </div>""", unsafe_allow_html=True)

    # Working Hours
    st.markdown("""
    <div class='panel-section'>
        <div class='panel-title'>🕐 Working Hours</div>
        <div class='hours-row'>
            <span>Mon – Sat</span>
            <span style='color:#f8bbd0;'>10 AM – 8 PM</span>
        </div>
        <div class='hours-row'>
            <span>Sunday</span>
            <span style='color:#f8bbd0;'>10 AM – 6 PM</span>
        </div>
        <div style='font-size:0.68rem; opacity:0.6; margin-top:0.3rem;'>
            * Confirm timings while booking
        </div>
    </div>""", unsafe_allow_html=True)

    # Services
    chips = "".join([f"<span class='service-chip'>{s}</span>"
                     for s in SERVICE_CATEGORIES])
    st.markdown(f"""
    <div class='panel-section'>
        <div class='panel-title'>💅 Our Services</div>
        {chips}
    </div>""", unsafe_allow_html=True)
